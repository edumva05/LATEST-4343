...
class TabBarController: UIViewController, UIGestureRecognizerDelegate {
    ...
    override func viewDidLoad() {
        ...
        AboutUs = storyboard.instantiateViewController(withIdentifier: "AboutUs")
        
        //Add stroyboards to array
        viewControllers = [ homeViewController, cartViewController,profileViewController, ideaViewController, settingsViewController, AboutUs]
